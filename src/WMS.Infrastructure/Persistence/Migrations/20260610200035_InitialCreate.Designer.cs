...
namespace WMS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260610200035_InitialCreate")]
            ...
            modelBuilder.Entity("WMS.Domain.Entities.Employee", b =>
                {
                    ...
                    b.ToTable("Employees", t =>
                        {
                            t.HasCheckConstraint("CK_Employee_DOB", "DATEDIFF(year, DOB, GETDATE()) >= 18");
                        });
                });
            ...
            modelBuilder.Entity("WMS.Domain.Entities.Leave", b =>
                {
                    ...
                    b.ToTable("Leaves", t =>
                        {
                            t.HasCheckConstraint("CK_Leave_Dates", "[FromDate] <= [ToDate]");
                        });
                });
